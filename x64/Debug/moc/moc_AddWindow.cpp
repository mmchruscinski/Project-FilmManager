...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAddWindowENDCLASS_t qt_meta_stringdata_CLASSAddWindowENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 12),  // "acceptSignal"
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 14)   // "acceptAddition"
    },
    "AddWindow",
    "acceptSignal",
    "",
...
void AddWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->acceptSignal(); break;
        case 1: _t->acceptAddition(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AddWindow::acceptSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
